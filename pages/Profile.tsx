    ...
    <div className="flex flex-col min-h-full bg-slate-50 text-slate-900 animate-in fade-in duration-500">
      <header className="px-6 pt-12 pb-6">
        <div className="flex items-center justify-between mb-8">
          <button className="material-symbols-outlined text-slate-400">arrow_back</button>
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="relative mb-6">
            <div className="w-32 h-32 rounded-full p-1.5 border-4 border-primary/20 shadow-[0_0_40px_rgba(237,29,35,0.1)]">
          ...
          <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Membro desde Outubro 2019</p>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4">
            {MOCK_HISTORY.slice(0, 3).map((match) => (
              <div key={match.id} className="bg-white rounded-3xl p-5 border border-slate-100 flex items-center justify-between group shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 font-medium">12 Out, 2023 • Local: Arena Sul</p>
                  </div>
                </div>
      ...
      <div className="fixed bottom-24 left-0 right-0 px-6 py-4 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent z-50">
        <button className="w-full h-16 bg-primary text-white rounded-2xl flex items-center justify-center gap-3 font-black uppercase tracking-widest text-xs shadow-xl shadow-primary/20 active:scale-95 transition-all">
